...
class FriendServiceImplTest {
    ...
    public void Befor() {
        ...
        User user3 = new User("user3@naver.com","1234", "김주성", UserRoleEnum.USER, USER_REGISTERED, 30,"010-1234-1236","sdf.jpg", UserGradeEnum.MOUNTAIN_GOD);
        User user4 = new User("user4@naver.com","1234", "김민선", UserRoleEnum.USER, USER_REGISTERED, 40,"010-1234-1237","sdf.jpg", UserGradeEnum.MOUNTAIN_GOD);
        User user5 = new User("user5@naver.com","1234", "김두영", UserRoleEnum.USER, USER_REGISTERED, 50,"010-1234-1238","sdf.jpg", UserGradeEnum.MOUNTAIN_GOD);
        User user6 = new User("user6@naver.com","1234", "한병두", UserRoleEnum.USER, USER_REGISTERED, 60,"010-1234-1239","sdf.jpg", UserGradeEnum.MOUNTAIN_GOD);
        User user7 = new User("user7@naver.com","1234", "한예슬", UserRoleEnum.USER, USER_REGISTERED, 70,"010-1234-1240","sdf.jpg", UserGradeEnum.MOUNTAIN_GOD);
        User user8 = new User("user8@naver.com","1234", "한지민", UserRoleEnum.USER, USER_REGISTERED, 80,"010-1234-1241","sdf.jpg", UserGradeEnum.MOUNTAIN_GOD);
