...
### 친구
#### 1:N 관계에서 매칭시스템 
> 하나의 유저가 가지고 있는 태그들 중 하나라도 같은 태그를 가지고 있는 유저를 매칭해야하는 기능을 구현하던 중 N+1 문제를 마주하게 되었습니다.
...
Batch size는 100번 발생하게 될 쿼리를 1번 이상으로 줄일 수 있지만 N+1문제가 발생하지 않는 것은 아니기 때문에 해법이 아니라고 생각했습니다.   
