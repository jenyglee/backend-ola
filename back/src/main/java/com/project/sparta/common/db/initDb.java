            ...
            for (int i=0; i<3; i++){
                userService.signup(
                    UserSignupDto.builder()
                        ...
                        .imageUrl(
                            "https://img.allurekorea.com/allure/2022/12/style_638c9fa344852-960x1200.jpg")
            ...
            for (int i=3; i<6; i++){
                userService.signup(
                    UserSignupDto.builder()
                        ...
                        .phoneNumber("01012345678")
                        .imageUrl(
                            "https://img.hankyung.com/photo/202102/1613803069762127.jpg")
            ...
            for (int i=6; i<10; i++){
                userService.signup(
                    UserSignupDto.builder()
                        ...
                        .phoneNumber("01012345678")
                        .imageUrl(
                            "https://t1.daumcdn.net/cfile/tistory/99276C3E5ACD853834")
