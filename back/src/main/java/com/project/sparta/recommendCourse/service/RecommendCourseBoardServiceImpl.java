...
public class RecommendCourseBoardServiceImpl implements RecommendCourseBoardService {
     ...
     */
    @Override
    public List<String> creatRecommendCourseBoard(List<MultipartFile> images, RecommendRequestDto requestPostDto, Long userId) throws IOException {
        ...
        RecommendCourseBoard post = RecommendCourseBoard.builder()
    ...
    //코스 수정
    @Override
    public List<String> modifyRecommendCourseBoard(Long id, List<MultipartFile> images, RecommendRequestDto requestPostDto, Long userId) throws IOException {
