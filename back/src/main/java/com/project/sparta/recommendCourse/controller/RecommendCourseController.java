...
public class RecommendCourseController {
    ...
    public String ImageUpload(@RequestPart(value = "image", required = false) List<MultipartFile> images)throws IOException{
        recommendCourseImgService.createImgList(images);
        return "https://pds.joongang.co.kr/news/component/htmlphoto_mmdata/202302/11/9e7dd875-5cd0-4776-9ca8-264c6fdb440a.jpg";
