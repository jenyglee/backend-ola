...
@SpringBootTest
public class AdminCommunityBoardTest {
  ...
  public void updateCommunityBoard(){
    ...
    CommunityBoardRequestDto afterRequestDto = CommunityBoardRequestDto
        ...
        .build();
    //when
    communityBoardService.adminUpdateCommunityBoard(communityBoard.getId(), afterRequestDto);
  ...
  public void deleteCommunityBoard() {
    ...
    //when
    communityBoardService.adminDeleteCommunityBoard(communityBoard.getId());
